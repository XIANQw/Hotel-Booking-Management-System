        ...
        <fieldset>
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="${pageContext.request.contextPath}/Service?method=getDemands" class="text-success">Your demands</a></li>
            ...
            <table class="table table-striped">
                ...
                <% for(DemandBean cmd : cmds) { %>
                    ...
                    <td><a href="${pageContext.request.contextPath}/Service?method=DeleteDemand" class="text-success">Delete</a></td>
                    </tr>
                <%}%>
                </tbody>
            </table>
